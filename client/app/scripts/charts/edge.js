...
function isStorageComponent(id) {
  const storageComponents = ['<persistent_volume>', '<storage_class>', '<persistent_volume_claim>', '<storage_pool>', '<disk>', '<storage_pool_claim>', '<volume_snapshot>', '<volume_snapshot_data>'];
