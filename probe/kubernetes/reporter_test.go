...
func (c *mockClient) WalkStoragePools(f func(kubernetes.StoragePool) error) error {
	return nil
}
...
func (c *mockClient) WalkVolumeSnapshotDatas(f func(kubernetes.VolumeSnapshotData) error) error {
	return nil
}
...
func (c *mockClient) DeletePersistentVolumeClaim(namespaceID, persistentVolumeClaimID string) error {
	return nil
}
...
func (c *mockClient) CloneVolumeSnapshot(namespaceID, VolumeSnapshotID string) error {
	return nil
}
